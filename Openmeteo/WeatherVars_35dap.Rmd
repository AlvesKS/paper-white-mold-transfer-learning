---
title: "Create weather vars for canopy closure prediction"
subtitle: "where the vars are between planting date and 35 dap"
author: "Denis Shah"
date: "`r Sys.Date()`"
...
wm_wvars_35dap <- bind_cols(env_wm, foo)
```


```{r save-the-data}
save(wm_wvars_35dap, file = here::here("Openmeteo", "wm_WeatherVars_35dap.RData"))
```
