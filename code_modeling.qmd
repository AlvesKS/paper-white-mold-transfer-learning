...
require(knitr)
## options
knitr::opts_chunk$set(eval = TRUE, echo = T, cache = T)
```

## Packages 

```{r load-libraries, message=FALSE, warning=F}
...
library(pminternal)
# to dowload this package use devtools::install_github("stephenrho/pminternal", build_vignettes = TRUE)
set.seed(2022)
