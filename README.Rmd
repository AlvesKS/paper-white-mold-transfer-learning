...
<!-- If you want centering in the title, author, date need to set the CSS style. -->
<!-- See https://stackoverflow.com/questions/43404487/how-do-i-center-my-yaml-heading-in-an-r-markdown-html-document from where the style options elow were taken. -->
