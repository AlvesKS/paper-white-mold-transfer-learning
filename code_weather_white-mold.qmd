...
In the research [repository](https://osf.io/v53py/){target="_blank"}, the directories containing the soil, weather, white mold can be downloaded using the folowing links([`data_era5.zip`](https://osf.io/download/k39bd/),[`soil_images.zip`](https://osf.io/download/2jfcz/), [`data_white-mold.zip`](https://osf.io/download/ehy26/)). You should unzip these files in the main directory to be able to reproduce the analysis.
:::
...
Kriging was performed following this [tutorial](https://www.erikkusch.com/post/krigr-mats/krigrworkshop/#kriging-by-shapefile)
...
plot(a11)
 # a11 = crop(a, ny_shape,mask=T)


# create a polygon from the previous raster file (this is going to be our mask for the all datasets) 

a21 = raster::rasterToPolygons(a11, dissolve=T)

# Mask our example dataseta2 = mask(a,ny_shape, touches =F)
